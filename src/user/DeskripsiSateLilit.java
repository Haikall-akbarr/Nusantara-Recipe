 ...
 * @author Haikal
 */
public class DeskripsiSateLilit extends javax.swing.JFrame {

    /**
     * Creates new form DeskripsiSateLilit
     */
    public DeskripsiSateLilit() {
        initComponents();
        loadDataToTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Sate_lilit2.png"))); // NOI18N
    ...
    if (conn != null) {
        try {
            String query = "SELECT * FROM deskripsi_nasiKuning WHERE nama_masakan = 'Sate Lilit'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeskripsiSateLilit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeskripsiSateLilit().setVisible(true);
            }
        });
    }
